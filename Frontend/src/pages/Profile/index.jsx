...
function Profile() {
    ...
    return (
        <div className="bg-white w-full h-full py-10 px-10 flex flex-col xl:flex-row xl:px-60 xl:bg-gray-100">
            <div className="flex flex-col mt-6 p-10 border-b xl:w-3/12 sm:flex-row xl:flex-col xl:mt-0">
                <div className="flex pr-3 w-72">
                    <div>
                        <img
                            className="w-20 h-20 object-cover rounded-full"
                            src="https://i.pinimg.com/originals/a9/f0/bc/a9f0bc1606813c59a5909d1de51080af.jpg"
                        />
                    </div>
            ...
            <div className="xl:w-9/12 h-5/6 bg-white">{activeTagMenu === 'profile' && <ProfileDetail />}</div>
        </div>
    );
}
